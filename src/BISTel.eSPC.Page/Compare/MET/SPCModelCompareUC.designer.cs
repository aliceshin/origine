namespace BISTel.eSPC.Page.Compare.MET
{
    partial class SPCModelCompareUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucSPCModelList = new BISTel.eSPC.Page.Compare.MET.SPCModelListUC();
            this.tabCompareResult = new System.Windows.Forms.TabPage();
            this.ucSpcModelCompareResultUC = new BISTel.eSPC.Page.Compare.MET.SPCModelCompareResultUC();
