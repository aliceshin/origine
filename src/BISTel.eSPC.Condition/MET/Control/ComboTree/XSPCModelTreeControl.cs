...
using BISTel.eSPC.Condition.MET.Controls.Tree;
using BISTel.eSPC.Condition.Controls;

namespace BISTel.eSPC.Condition.MET.Controls.ComboTree
{
    /// <summary>
    /// Multivariate Model 에서 사용 (Step + Mva Model) Tree
    /// </summary>
    public class XSPCModelTreeControl : BISTel.eSPC.Condition.Controls.ComboTree.XSPCModelTreeControl
    {
    }
}