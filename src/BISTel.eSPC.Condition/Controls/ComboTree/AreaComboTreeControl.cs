...
{
    class AreaComboTreeControl : IAddChildNodeToDCTreeView
    {
        #region : Field
        ...
        public void SetDCTree(BISTel.PeakPerformance.Client.BISTelControl.BTreeView btv)
        {
            ...
            if (this.GetType().FullName == "BISTel.eSPC.Condition.Controls.ComboTree.AreaComboTreeControl")
            {
                llstCondtion.Add(Definition.CONDITION_KEY_CATEGORY, "SPC_MODEL_LEVEL");
            }
            else if (this.GetType().FullName == "BISTel.eSPC.Condition.MET.Controls.ComboTree.AreaComboTreeControl")
            {
                llstCondtion.Add(Definition.CONDITION_KEY_CATEGORY, "SPC_MET_MODEL_LEVEL");
            }
            else if (this.GetType().FullName == "BISTel.eSPC.Condition.ATT.Controls.ComboTree.AreaComboTreeControl")
            {
