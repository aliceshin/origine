...
namespace BISTel.eSPC.Page.History
{
    public partial class SPCModelVersionHistory : BasePageUCtrl
    {
        ...
        //public VersionDeleteButtonClickEventHandler VersionDeleteButtonClicked;
        ...
        public void bButtonList1_ButtonClick(string name)
        {
        ...
        private void VersionDeleteClicked()
        {
            ...
            //if (VersionDeleteButtonClicked != null)
            //{
            //    var args = new VersionDeleteButtonClickedEventArgs { ModelID = modelID, Versions = version.ToArray() };
            //    VersionDeleteButtonClicked(this, args);
            //}
        }
        ...
        public void bSpread1_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
            if (alSelect.Count > 0)
            {
                if (alSelect.ContainsValue(e.Row))
                {
        ...
        public void bSpread1_MouseDown(object sender, MouseEventArgs e)
        {
