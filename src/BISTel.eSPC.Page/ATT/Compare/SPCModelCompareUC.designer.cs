namespace BISTel.eSPC.Page.ATT.Compare
{
    partial class SPCModelCompareUC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucSPCModelList = new BISTel.eSPC.Page.ATT.Compare.SPCModelListUC();
            this.tabCompareResult = new System.Windows.Forms.TabPage();
            this.ucSpcModelCompareResultUC = new BISTel.eSPC.Page.ATT.Compare.SPCModelCompareResultUC();
