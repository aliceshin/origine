...
{
    public partial class SPCAnalysisConditionOld : ADynamicCondition
    {
        ...
        public SPCAnalysisConditionOld()
        {
           ...
           // this.blblSortingKey.Text = _mlthandler.GetVariable(Definition.Analysis.LABEL_SORTING_KEY);
        ...
        private void SetCondition(LinkedList ll)
        {
            ...
            try
            {
                ...
                if (_condition.Contains(Definition.DynamicCondition_Search_key.DATETIME_FROM))
                {
                    ...
                    this._sStartTime = DCUtil.GetValueData((DataTable)_condition[Definition.DynamicCondition_Search_key.VALUEDATA]);
                    this.dateCondition1.DateTimeStart= DateTime.Parse(this._sEndTime);
                }
                ...
                if (_condition.Contains(Definition.DynamicCondition_Search_key.DATETIME_TO))
                {
                    ...
                    this._sEndTime = DCUtil.GetValueData((DataTable)_condition[Definition.DynamicCondition_Search_key.VALUEDATA]);
        ...
        private void PROC_BindChartList()
        {
            ...
            {                
                this.bchkChartList.DataSource = ds.Tables[0];
                this.bchkChartList.ValueMember = Definition.CONDITION_KEY_CODE;
                this.bchkChartList.DisplayMember = Definition.CONDITION_KEY_NAME;                            
            }
        }
        ...
        private void PROC_BindSortingKey()
        {
            ...
            if (!DataUtil.IsNullOrEmptyDataSet(ds))
            {
                this.bcboSortingKey.DataSource = ds.Tables[0];
                this.bcboSortingKey.ValueMember = Definition.CONDITION_KEY_CODE;
                this.bcboSortingKey.DisplayMember = Definition.CONDITION_KEY_NAME;
            }
        }
        ...
        private void PROC_BindTargetOperation()
        {
            ...
            {
                this.bcboTargetOperation.DataSource = _dsCode.Tables[0];
                this.bcboTargetOperation.ValueMember = Definition.DynamicCondition_Condition_key.OPERATION_ID;
                this.bcboTargetOperation.DisplayMember = Definition.DynamicCondition_Condition_key.CODE_DESCRIPTION;
            }
        }
