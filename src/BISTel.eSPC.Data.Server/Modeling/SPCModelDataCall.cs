    ...
    public class SPCModelDataCall : DataBase
    {
        ...
        public DataSet GetSPCModelData(byte[] param, bool isATT)
        {
            ...
            try
            {
                ...
                //#00. MODEL_MST_SPC
                sb.Append("SELECT * ");
                sb.Append("FROM " + modelMstTblName);
                sb.Append(" WHERE 1 = 1 ");
                ...
                if (llstParam.Contains(Definition.CONDITION_KEY_MODEL_CONFIG_RAWID))
                {
                    sb.Append("   AND RAWID IN (SELECT MODEL_RAWID ");
                    sb.Append("                 FROM " + modelConfigMstTblName);
                    sb.Append("                 WHERE RAWID = :MODEL_CONFIG_RAWID) ");
                }
                ...
                sb.Append("  FROM " + modelConfigOptMstTblName + " A ");
                sb.Append("         LEFT OUTER JOIN (SELECT CODE, NAME ");
                sb.Append("                          FROM CODE_MST_PP ");
                sb.Append("                          WHERE CATEGORY = 'SPC_PARAM_CATEGORY') B ");
                sb.Append("                  ON (A.SPC_PARAM_CATEGORY_CD = B.CODE) ");
                sb.Append("         LEFT OUTER JOIN (SELECT CODE, NAME ");
                sb.Append("                          FROM CODE_MST_PP ");
                sb.Append("                          WHERE CATEGORY = 'SPC_PRIOTIRY') C ");
                sb.Append("                  ON (A.SPC_PRIORITY_CD = C.CODE) ");
                sb.Append(" WHERE 1 = 1 ");

                if (llstParam.Contains(Definition.CONDITION_KEY_MODEL_RAWID))
                {
                    sb.Append("  AND A.model_config_rawid IN (SELECT rawid ");
                    sb.Append("                               FROM " + modelConfigMstTblName + " ");
                ...
                sb.Append("   FROM " + modelRuleMstTblName + " A ");
                sb.Append("        LEFT OUTER JOIN " + ruleMstTblName + " B ");
                ...
                sb.Append("           FROM " + modelRuleOptMstTblName + " MRO,                                        ");
                sb.Append("                (SELECT MRM.RAWID, MRM.SPC_RULE_NO                                         ");
                sb.Append("                   FROM " + modelRuleMstTblName + " MRM, " + modelConfigMstTblName + " MCM ");
                sb.Append("                  WHERE 1 = 1                                                              ");
                ...
                sb.Append("           FROM " + ruleMstTblName + " A, " + ruleOptMstTblName + " B                      ");
        ...
        public DataSet GetSPCModelDatabyChartID(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            StringBuilder sb = new StringBuilder();
            LinkedList llstParam = new LinkedList();
            ...
            string modelConfigMstTblName = string.Empty;
            string modelConfigOptMstTblName = string.Empty;
            string modelGroupMstTblName = string.Empty;
            ...
            if (isATT)
            {
                ...
                modelConfigMstTblName = TABLE.MODEL_CONFIG_ATT_MST_SPC;
                modelConfigOptMstTblName = TABLE.MODEL_CONFIG_OPT_ATT_MST_SPC;
                modelGroupMstTblName = TABLE.MODEL_GROUP_ATT_MST_SPC;
            }
            else
            {
                modelMstTblName = TABLE.MODEL_MST_SPC;
                modelConfigMstTblName = TABLE.MODEL_CONFIG_MST_SPC;
                modelConfigOptMstTblName = TABLE.MODEL_CONFIG_OPT_MST_SPC;
                modelGroupMstTblName = TABLE.MODEL_GROUP_MST_SPC;
            }
            //ATT에 따른 처리 by KBLEE, End
            ...
            try
            {
                ...
                //#00. MODEL_MST_SPC
                sb.Append("SELECT B.RAWID LOCATION_RAWID, B.SITE, B.LINE, B.FAB, ");
                sb.Append("       C.RAWID AREA_RAWID, C.AREA, A.RAWID MODEL_RAWID, ");
                sb.Append("       A.SPC_MODEL_NAME, A.EQP_MODEL, A.GROUP_RAWID ");
                sb.Append(" FROM " + modelMstTblName + " A, LOCATION_MST_PP B, AREA_MST_PP C ");
                sb.Append(" WHERE 1 = 1 ");
                ...
                if (llstParam.Contains(Definition.CONDITION_KEY_MODEL_CONFIG_RAWID))
                {
                    sb.Append("   AND A.RAWID = (SELECT MODEL_RAWID ");
                    sb.Append("                  FROM " + modelConfigMstTblName + " ");
                    sb.Append("                  WHERE RAWID = :MODEL_CONFIG_RAWID) ");
                }
                ...
                else
                {
                    ...
                    sb.Append("       LEFT OUTER JOIN (SELECT CODE, NAME " );
                    sb.Append("                        FROM CODE_MST_PP ");
                    sb.Append("                        WHERE CATEGORY = 'SPC_PARAM_TYPE') B ");
                    sb.Append("                 ON mcms.PARAM_TYPE_CD = B.CODE ");
                    sb.Append("       LEFT OUTER JOIN (SELECT CODE, NAME ");
                    sb.Append("                        FROM CODE_MST_PP ");
                    sb.Append("                        WHERE CATEGORY='SPC_MANAGE_TYPE') cc ");
                    sb.Append("                 ON mcms.manage_type_cd = cc.code ");
                    sb.Append(" WHERE 1 = 1 ");
                }
                ...
                sb.Remove(0, sb.Length);
                sb.Append("SELECT * ");
                sb.Append(" FROM " + modelGroupMstTblName);
                ...
                else
                {
                    ...
                    dtGroup.TableName = modelGroupMstTblName;
        ...
        public DataSet GetSPCCalcModelData(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            LinkedList llstParam = new LinkedList();
            ...
            ////////refactoring 전에는 전역변수였음 by KBLEE, start
            string SQL_SEARCH_CALC_MODEL = " SELECT *                                     " +
                                           "   FROM " + modelMstTblName                     +
                                           "  WHERE RAWID = :RAWID                        ";
            ////////refactoring 전에는 전역변수였음 by KBLEE, end
            string sSQL = "";
            ...
            try
            {
                ...
                sb.Append("       KEY_ORDER, CREATE_DTTS, CREATE_BY, LAST_UPDATE_DTTS,       ");
                sb.Append("       LAST_UPDATE_BY, GROUP_YN, VERSION                          ");
                sb.Append(" FROM " + modelContextMstTblName                                   );
                sb.Append(" WHERE MODEL_CONFIG_RAWID IN (SELECT RAWID                        ");
                sb.Append("                              FROM MODEL_CONFIG_MST_SPC           ");
                sb.Append("                              WHERE MODEL_RAWID = :RAWID)         ");
        ...
        public DataSet GetSPCCalcModelDataSave(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            LinkedList llstParam = new LinkedList();
            LinkedList llstWhereData = new LinkedList();
            ...
            //refactoring 전에는 전역변수였음 by KBLEE, start
            //SPC-812 Calculation
            string SQL_SEARCH_CALC_MODEL_SAVE = 
                " SELECT *                                      " +
                "   FROM " + modelMstTblName                      +
            ...
            //SPC-812 Calculation
            //string SQL_SEARCH_CALC_MODEL_CONFIG_SAVE = "           SELECT *                           "
            //                                        + "             FROM MODEL_CONFIG_MST_SPC         "
            //                                        + "            WHERE RAWID = :RAWID               ";
            //SPC-812 Calculation
            //string SQL_SEARCH_CALC_MODEL_CONTEXT_SAVE = " SELECT *                                    "
            //                                        + "            FROM MODEL_CONTEXT_MST_SPC         "
        ...
        public DataSet GetSPCMulCalcModelDataPopup(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            LinkedList llstParam = new LinkedList();
            LinkedList llstWhereData = new LinkedList();
            ...
            //refactoring 전에는 전역 변수였음. by KBLEE, start
            //SPC-704 MultiCalc Popup
            string SQL_SEARCH_MULTI_CALC_MODEL_POPUP = 
                " SELECT *                                     " +
                " FROM " + modelMstTblName                       +
                " WHERE RAWID IN (SELECT DISTINCT MODEL_RAWID  " +
                "                 FROM " + modelConfigMstTblName +
                "                 WHERE RAWID IN(              ";
            //refactoring 전에는 전역 변수였음. by KBLEE, end
            ...
            try
            {
                ...
                {
                    sb2.Append(" SELECT *                          ");
                    sb2.Append(" FROM MODEL_CONFIG_ATT_MST_SPC     ");
                ...
                sb3.Append("       KEY_ORDER, CREATE_DTTS, CREATE_BY, LAST_UPDATE_DTTS,          ");
                sb3.Append("       LAST_UPDATE_BY, GROUP_YN, VERSION                             ");
                sb3.Append(" FROM " + modelContextMstTblName                                      );
        ...
        public DataSet GetSPCCalcModelDataPopup(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            LinkedList llstParam = new LinkedList();
            LinkedList llstWhereData = new LinkedList();
            ...
            string SQL_SEARCH_CALC_MODEL_POPUP = 
                " SELECT *                                         " +
                " FROM " + modelMstTblName                           +
                " WHERE RAWID IN (SELECT DISTINCT MODEL_RAWID      " +
                "                 FROM " + modelConfigMstTblName     +
        ...
        public DataSet CreateSPCModel(ConfigMode configMode, string sUserID, DataTable dtModel, DataTable dtConfig, DataTable dtConfigOpt, DataTable dtContext, DataTable dtRule, DataTable dtRuleOpt, DataTable dtAutoCalc, ref string ref_Config_RawID, string groupRawid, bool useComma, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            string seqModelMst = string.Empty;
            string seqModelConfigMst = string.Empty;
            string seqModelConfigOptMst = string.Empty;
            string seqModelContextMst = string.Empty;
            string seqModelRuleMst = string.Empty;
            string seqModelRuleOptMst = string.Empty;
            string seqModelAutoCalcMst = string.Empty;
            ...
            if (isATT)
            {
                ...
                seqModelMst = SEQUENCE.SEQ_MODEL_ATT_MST_SPC;
                seqModelConfigMst = SEQUENCE.SEQ_MODEL_CONFIG_ATT_MST_SPC;
                seqModelConfigOptMst = SEQUENCE.SEQ_MODEL_CONFIG_OPT_ATT_MST_SPC;
                seqModelContextMst = SEQUENCE.SEQ_MODEL_CONTEXT_ATT_MST_SPC;
                seqModelRuleMst = SEQUENCE.SEQ_MODEL_RULE_ATT_MST_SPC;
                seqModelRuleOptMst = SEQUENCE.SEQ_MODEL_RULE_OPT_ATT_MST_SPC;
                seqModelAutoCalcMst = SEQUENCE.SEQ_MODEL_AUTOCALC_ATT_MST_SPC;
            }
            else
            {
                modelMstTblName = TABLE.MODEL_MST_SPC;
                ...
                seqModelMst = SEQUENCE.SEQ_MODEL_MST_SPC;
                seqModelConfigMst = SEQUENCE.SEQ_MODEL_CONFIG_MST_SPC;
                seqModelConfigOptMst = SEQUENCE.SEQ_MODEL_CONFIG_OPT_MST_SPC;
                seqModelContextMst = SEQUENCE.SEQ_MODEL_CONTEXT_MST_SPC;
                seqModelRuleMst = SEQUENCE.SEQ_MODEL_RULE_MST_SPC;
                seqModelRuleOptMst = SEQUENCE.SEQ_MODEL_RULE_OPT_MST_SPC;
                seqModelAutoCalcMst = SEQUENCE.SEQ_MODEL_AUTOCALC_MST_SPC;
            }
            //ATT에 따른 처리 by KBLEE, End
            ...
            try
            {
                ...
                foreach (DataRow drModel in dtModel.Rows)
                {
                    ...
                    {
                        modelRawID = base.GetSequence(seqModelMst);
                        ...
                        base.Insert(modelMstTblName, llstFieldData);
                    ...
                    foreach (DataRow drConfig in dtConfig.Rows)
                    {
                        decimal configRawID = base.GetSequence(seqModelConfigMst);
                        ...
                        base.Insert(modelConfigMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqModelConfigOptMst), "");
                            llstFieldData.Add(COLUMN.MODEL_CONFIG_RAWID, configRawID);
                            ...
                            base.Insert(modelConfigOptMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqModelContextMst), "");
                            llstFieldData.Add(COLUMN.MODEL_CONFIG_RAWID, configRawID);
                            ...
                            base.Insert(modelContextMstTblName, llstFieldData);
                        ...
                        foreach (DataRow drRule in dtRule.Rows)
                        {
                            decimal ruleRawID = base.GetSequence(seqModelRuleMst);
                            ...
                            base.Insert(modelRuleMstTblName, llstFieldData);
                            ...
                            if (drRuleOpts == null || drRuleOpts.Length == 0)
                            {
                                continue;
                            }
                            ...
                            {
                                llstFieldData.Clear();
                                llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqModelRuleOptMst), "");
                                llstFieldData.Add(COLUMN.MODEL_RULE_RAWID, ruleRawID);
                                ...
                                base.Insert(modelRuleOptMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqModelAutoCalcMst), "");
                            llstFieldData.Add(COLUMN.MODEL_CONFIG_RAWID, configRawID);
                            ...
                            base.Insert(modelAutoCalcMstTblName, llstFieldData);
        ...
        public DataSet ModifySPCModel(string sUserID, DataTable dtModel, DataTable dtConfig, DataTable dtConfigOpt, DataTable dtContext, DataTable dtRule, DataTable dtRuleOpt, DataTable dtAutoCalc, List<string> lstChangedMasterColList, string comment, string changedItems, string groupRawid, bool useComma, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            try
            {
                ...
                foreach (DataRow drModel in dtModel.Rows)
                {
                    ...
                    base.Update(modelMstTblName, llstFieldData, sWhereQuery, llstWhereData);
                    ...
                    foreach (DataRow drConfig in dtConfig.Rows)
                    {
                        ...
                        base.Update(modelConfigMstTblName, llstFieldData, sWhereQuery, llstWhereData);
                        ...
                        foreach (DataRow drConfigOpt in dtConfigOpt.Rows)
                        {
                            ...
                            base.Update(modelConfigOptMstTblName, llstFieldData, sWhereQuery, llstWhereData);
                        ...
                        base.Delete(modelContextMstTblName, sWhereQuery, llstWhereData);
                        ...
                        base.Delete(modelRuleOptMstTblName, sWhereQuery, llstWhereData);
                        ...
                        base.Delete(modelRuleMstTblName, sWhereQuery, llstWhereData);
                        ...
                        foreach (DataRow drAutoCalc in dtAutoCalc.Rows)
                        {
                            ...
                            base.Update(modelAutoCalcMstTblName, llstFieldData, sWhereQuery, llstWhereData);
        ...
        public DataSet DeleteSPCModel(byte[] param, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            try
            {
                ...
                sWhereQuery = 
                    " WHERE MODEL_RULE_RAWID IN (SELECT RAWID " +
                    "                           FROM " + modelRuleMstTblName +
                    "                           WHERE MODEL_CONFIG_RAWID IN (SELECT RAWID " +
                    "                                                        FROM " + modelConfigMstTblName +
                    "                                                        WHERE MODEL_RAWID = :MODEL_RAWID)) ";
                ...
                base.Delete(modelConfigOptMstTblName, sWhereQuery, llstWhereData);
                ...
                base.Delete(modelAutoCalcMstTblName, sWhereQuery, llstWhereData);
                ...
                base.Delete(modelConfigMstTblName, sWhereQuery, llstWhereData);
                ...
                base.Delete(modelMstTblName, sWhereQuery, llstWhereData);
        ...
        public DataSet DeleteSPCModelConfig(byte[] param, bool isATT)
        {
            DataSet dsResult = new DataSet();
                    ...
                    if (arrTemp.Count > 300)
                    {
                        ...
                        for (int k = 0; k < arrsModelRawID.Count; k++)
                        {
                            ...
                            sWhereQuery = 
                                " WHERE MODEL_RULE_RAWID IN (SELECT RAWID " +
                                "                           FROM " + modelRuleMstTblName +
                                "                           WHERE MODEL_CONFIG_RAWID IN ({0})) ";
                            sWhereQuery = string.Format(sWhereQuery, strWhereCondition);
        ...
        public bool DeleteSPCModelConfig(string strSubconfig, bool isATT)
        {
            bool _bResult = true;
        ...
        public DataSet GetSPCRuleMasterData(byte[] param, bool isATT)
        {
            DataSet dsReturn = new DataSet();
            ...
            try
            {
                ...
                sb.Append(" SELECT A.*, SPC_RULE_NO || '. ' || DESCRIPTION AS SPC_RULE ");
                sb.Append(" FROM " + ruleMstTblName + " A ");
                sb.Append(" ORDER BY A.SPC_RULE_NO ");
                ...
                {
                    DataTable dtRule = dsTemp.Tables[0].Copy();
                    dtRule.TableName = ruleMstTblName;
                ...
                {
                    DataTable dtRuleOPT = dsTemp.Tables[0].Copy();
                    dtRuleOPT.TableName = ruleOptMstTblName;
        ...
        public DataSet GetSPCDefaultModelData(byte[] param, bool isATT)
        {
            ...
            string defConfigMstTblName = string.Empty;
            string defConfigOptMstTblName = string.Empty;
            string defContextMstTblName = string.Empty;
            string defRuleMstTblName = string.Empty;
            string defRuleOptMstTblName = string.Empty;
            ...
            if (isATT)
            {
                ...
                defConfigMstTblName = TABLE.DEF_CONFIG_ATT_MST_SPC;
                defConfigOptMstTblName = TABLE.DEF_CONFIG_OPT_ATT_MST_SPC;
                defContextMstTblName = TABLE.DEF_CONTEXT_ATT_MST_SPC;
                defRuleMstTblName = TABLE.DEF_RULE_ATT_MST_SPC;
                defRuleOptMstTblName = TABLE.DEF_RULE_OPT_ATT_MST_SPC;
            }
            else
            {
                modelMstTblName = TABLE.MODEL_MST_SPC;
                ...
                defConfigMstTblName = TABLE.DEF_CONFIG_MST_SPC;
                defConfigOptMstTblName = TABLE.DEF_CONFIG_OPT_MST_SPC;
                defContextMstTblName = TABLE.DEF_CONTEXT_MST_SPC;
                defRuleMstTblName = TABLE.DEF_RULE_MST_SPC;
                defRuleOptMstTblName = TABLE.DEF_RULE_OPT_MST_SPC;
            }
            //ATT에 따른 처리 by KBLEE, End
            ...
            try
            {
                ...
                DataTable dtModel = comData.GetTableSchema(modelMstTblName);
                dtModel.TableName = modelMstTblName;
                ...
                {
                    sb.Append("SELECT '' AS MODEL_RAWID, '' AS PARAM_TYPE_CD, '' AS PARAM_ALIAS,                   ");
                    sb.Append("       '' AS COMPLEX_YN, '' AS PARAM_LIST, '' AS REF_PARAM, '' AS REF_PARAM_LIST,   ");
                    sb.Append("       '' AS MAIN_YN, '' MANAGE_TYPE_NAME, 'Y' AS ACTIVATION_YN,                    ");
                    sb.Append("       'Y' AS SUB_INTERLOCK_YN, 'Y' AS INHERIT_MAIN_YN, 'Y' AS SUB_AUTOCALC_YN,     ");
                    sb.Append("       'N' AS USE_NORM_YN, 'N' AS VALIDATION_SAME_MODULE_YN, 'L' AS SPC_DATA_LEVEL, ");
                ...
                sb.Append("  FROM " + defConfigOptMstTblName + " A ");
                sb.Append("       LEFT OUTER JOIN (SELECT CODE, NAME ");
                sb.Append("                        FROM CODE_MST_PP ");
                sb.Append("                        WHERE CATEGORY = 'SPC_PARAM_CATEGORY') B ");
                sb.Append("                 ON (A.SPC_PARAM_CATEGORY_CD = B.CODE) ");
                ...
                sb.Append("                 ON (A.SPC_PRIORITY_CD = C.CODE) ");
                sb.Append(" WHERE 1 = 1 ");
                sb.Append("   AND A.DEF_CONFIG_RAWID = (SELECT RAWID ");
                sb.Append("                             FROM " + defConfigMstTblName + " ");
                ...
                sb.Append(" FROM " +  defContextMstTblName + " DCMS, ");
                sb.Append("     (SELECT CODE,NAME ");
                sb.Append("      FROM code_mst_pp ");
                sb.Append("      WHERE category='CONTEXT_TYPE' ");
                sb.Append("      UNION ");
                ...
                sb.Append("   AND DCMS.DEF_CONFIG_RAWID = (SELECT RAWID ");
                sb.Append("                                FROM " + defConfigMstTblName);
                sb.Append("                                WHERE LOCATION_RAWID = :LINE_RAWID ");
                sb.Append("                                AND AREA_RAWID = :AREA_RAWID ");
                sb.Append("                                AND NVL(EQP_MODEL, '^') = NVL(:EQP_MODEL,'^') ) ");
                ...
                sb.Append("   FROM " + defRuleMstTblName + " A ");
                sb.Append("        LEFT OUTER JOIN " + defRuleOptMstTblName + " B ");
                sb.Append("          ON (A.RAWID = B.DEF_RULE_RAWID) ");
                sb.Append("        LEFT OUTER JOIN ");
                sb.Append("             (SELECT A.RAWID AS RULE_RAWID, A.SPC_RULE_NO, ");
                sb.Append("                     B.RULE_OPTION_NO, B.OPTION_NAME, B.DESCRIPTION ");
                sb.Append("                FROM " + ruleMstTblName + " A ");
                sb.Append("                     LEFT OUTER JOIN " + ruleOptMstTblName + " B ");
                sb.Append("                       ON (A.RAWID = B.RULE_RAWID) ");
                sb.Append("             ) C ");
                sb.Append("          ON (A.SPC_RULE_NO = C.SPC_RULE_NO AND B.RULE_OPTION_NO = C.RULE_OPTION_NO) ");
                sb.Append(" WHERE 1 = 1 ");
                ...
                else
                {
                    ...
                    dAutoCalc.TableName = modelAutoCalcMstTblName;
        ...
        public DataSet SaveDefaultConfig(string sUserID, DataTable dtModel, DataTable dtConfig, DataTable dtConfigOpt, DataTable dtContext, DataTable dtRule, DataTable dtRuleOpt, DataTable dtAutoCalc, bool useComma, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            string defRuleMstTblName = string.Empty;
            string defRuleOptMstTblName = string.Empty;
            string defAutoCalcMstTblName = string.Empty;

            string seqDefConfigMst = string.Empty;
            string seqDefConfigOptMst = string.Empty;
            string seqDefContextMst = string.Empty;
            string seqDefRuleMst = string.Empty;
            string seqDefRuleOptMst = string.Empty;
            string seqDefAutoCalcMst = string.Empty;
            ...
            if (isATT)
            {
                ...
                defRuleMstTblName = TABLE.DEF_RULE_ATT_MST_SPC;
                defRuleOptMstTblName = TABLE.DEF_RULE_OPT_ATT_MST_SPC;
                defAutoCalcMstTblName = TABLE.DEF_AUTOCALC_ATT_MST_SPC;

                seqDefConfigMst = SEQUENCE.SEQ_DEF_CONFIG_ATT_MST_SPC;
                seqDefConfigOptMst = SEQUENCE.SEQ_DEF_CONFIG_OPT_ATT_MST_SPC;
                seqDefContextMst = SEQUENCE.SEQ_DEF_CONTEXT_ATT_MST_SPC;
                seqDefRuleMst = SEQUENCE.SEQ_DEF_RULE_ATT_MST_SPC;
                seqDefRuleOptMst = SEQUENCE.SEQ_DEF_RULE_OPT_ATT_MST_SPC;
                seqDefAutoCalcMst = SEQUENCE.SEQ_DEF_AUTOCALC_ATT_MST_SPC;
            }
            else
            {
                defConfigMstTblName = TABLE.DEF_CONFIG_MST_SPC;
                ...
                defRuleMstTblName = TABLE.DEF_RULE_MST_SPC;
                defRuleOptMstTblName = TABLE.DEF_RULE_OPT_MST_SPC;
                defAutoCalcMstTblName = TABLE.DEF_AUTOCALC_MST_SPC;

                seqDefConfigMst = SEQUENCE.SEQ_DEF_CONFIG_MST_SPC;
                seqDefConfigOptMst = SEQUENCE.SEQ_DEF_CONFIG_OPT_MST_SPC;
                seqDefContextMst = SEQUENCE.SEQ_DEF_CONTEXT_MST_SPC;
                seqDefRuleMst = SEQUENCE.SEQ_DEF_RULE_MST_SPC;
                seqDefRuleOptMst = SEQUENCE.SEQ_DEF_RULE_OPT_MST_SPC;
                seqDefAutoCalcMst = SEQUENCE.SEQ_DEF_AUTOCALC_MST_SPC;
            }
            //ATT에 따른 처리 by KBLEE, End
            ...
            try
            {
                ...
                foreach (DataRow drModel in dtModel.Rows)
                {
                    ...
                    sWhereQuery = 
                        " WHERE DEF_RULE_RAWID IN (SELECT RAWID " +
                        "                         FROM " + defRuleMstTblName +
                        "                         WHERE DEF_CONFIG_RAWID IN (SELECT RAWID " +
                        "                                                    FROM " + defConfigMstTblName +
                        "                                                    WHERE {0} = :{0} " +
                        "                                                    AND {1} = :{1} " +
                        "                                                    AND NVL({2}, '-') = :{2})) ";
                    sWhereQuery = string.Format(sWhereQuery, COLUMN.LOCATION_RAWID, COLUMN.AREA_RAWID, COLUMN.EQP_MODEL);

                    base.Delete(defRuleOptMstTblName, sWhereQuery, llstWhereData);
                    ...
                    base.Delete(defRuleMstTblName, sWhereQuery, llstWhereData);
                    ...
                    base.Delete(defContextMstTblName, sWhereQuery, llstWhereData);
                    ...
                    base.Delete(defConfigOptMstTblName, sWhereQuery, llstWhereData);
                    ...
                    base.Delete(defAutoCalcMstTblName, sWhereQuery, llstWhereData);
                    ...
                    base.Delete(defConfigMstTblName, sWhereQuery, llstWhereData);
                    ...
                    foreach (DataRow drConfig in dtConfig.Rows)
                    {
                        decimal configRawID = base.GetSequence(seqDefConfigMst);
                        ...
                        base.Insert(defConfigMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqDefConfigOptMst), "");
                            ...
                            base.Insert(defConfigOptMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqDefContextMst), "");
                            llstFieldData.Add(COLUMN.DEF_CONFIG_RAWID, configRawID);
                            ...
                            base.Insert(defContextMstTblName, llstFieldData);
                        ...
                        foreach (DataRow drRule in dtRule.Rows)
                        {
                            decimal ruleRawID = base.GetSequence(seqDefRuleMst);
                            ...
                            base.Insert(defRuleMstTblName, llstFieldData);
                            ...
                            {
                                llstFieldData.Clear();
                                llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqDefRuleOptMst), "");
                                ...
                                base.Insert(defRuleOptMstTblName, llstFieldData);
                        ...
                        {
                            llstFieldData.Clear();
                            llstFieldData.Add(string.Format("{0}+{1}.NEXTVAL", COLUMN.RAWID, seqDefAutoCalcMst), "");
                            llstFieldData.Add(COLUMN.DEF_CONFIG_RAWID, configRawID);
                            ...
                            base.Insert(defAutoCalcMstTblName, llstFieldData);
        ...
        public string CheckDuplicateSPCModel(byte[] param, bool isATT)
        {
            bool bResult = true;
            string strResult = "";
            ...
            try
            {
                ...
                //refactoring 전에는 전역변수였음. by KBLEE, start
                string SQL_GET_DUPLICATE_SPC_NAME = 
                    " SELECT   DISTINCT RAWID, SPC_MODEL_NAME " +
                    " FROM " + modelMstTblName                  +
                ...
                //refactoring 전에는 전역변수였음. by KBLEE, start
                string SQL_GET_DUPLICATE_SPC_MODEL_RAWID = 
                    " SELECT   DISTINCT A.RAWID, A.SPC_MODEL_NAME                      " +
                    " FROM " + modelMstTblName + " A, " + modelConfigMstTblName + " B, " + 
                               modelContextMstTblName + " C                            " +
                ...
                if (dsReturn != null && dsReturn.Tables.Count > 0)
                {
                    ...
                    {
                        //refactoring 전에는 전역변수였음. by KBLEE, start
                        string SQL_GET_DUPLICATE_SPC_MODEL = 
                            " SELECT   C.RAWID, C.CONTEXT_KEY, C.CONTEXT_VALUE, C.KEY_ORDER        " + 
                            "     FROM " + modelMstTblName + " A, " + modelConfigMstTblName + " B, " +
                                           modelContextMstTblName + " C                            " + 
                            "    WHERE A.RAWID = B.MODEL_RAWID                                     " + 
                            "      AND B.RAWID = C.MODEL_CONFIG_RAWID                              " + 
        ...
        public bool SaveInterlockYN(byte[] param, bool isATT)
        {
            bool bReturn = true;
        ...
        public bool SaveSPCModelSpecData(byte[] param, bool isATT)
        {
            bool bReturn = true;
        ...
        public bool SaveSpecMultiCalcData(byte[] param, bool isATT)
        {
            bool bReturn = true;
            ArrayList arrRawID = new ArrayList();
            ArrayList arrInterlock = new ArrayList();
        ...
        public bool SaveSpecCalcData(byte[] param, bool isATT)
        {
            bool bReturn = true;
            ArrayList arrRawID = new ArrayList();
            ArrayList arrInterlock = new ArrayList();
        ...
        public DataSet ModifySPCSubModel(string sConfigRawID, DataTable dtRule, DataTable dtRuleOpt, string sUserID, ref string sConfigRawid, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            //ATT에 따른 처리 by KBLEE, start
            string sql_Update_Model_Config_Mst_Spc_For_Subconfig = string.Empty;
            string sql_Delete_Model_Rule_Opt_Mst_Spc_For_Subconfig = string.Empty;
            string sql_Delete_Model_Rule_Mst_Spc_For_Subconfig = string.Empty;
            string sql_Select_Sub_Config_Rawid = string.Empty;
                ...
                if (sArrModelConfigRawID != null && sArrModelConfigRawID.Length > 0)
                {
                    ...
                    for (int i = 0; i < sArrModelConfigRawID.Length; i++)
                    {
                        ...
                        foreach (DataRow drRule in dtRule.Rows)
                        {
                            if (kTemp == 0)
                            {
                                ruleRawID = base.GetSequenceCount(seqModelRuleMst, 500);
                            }
                            ...
                            foreach (DataRow drRuleOpt in drRuleOpts)
                            {
                                if (jTemp == 0)
                                {
                                    ruleOptRawID = base.GetSequenceCount(seqModelRuleOptMst, 500);
                                }
                    ...
                    if (arrRawID.Count > 0)
                    {
                        ...
                        base.InsertBatch(modelRuleMstTblName, llstFieldData);
                        ...
                        base.InsertBatch(modelRuleOptMstTblName, llstFieldData);
        ...
        public DataSet ModifySPCSubModelContext(string sConfigRawID, DataTable dtContext, string sUserID, bool isOnlyMainGroup, string groupRawid, bool isATT)
        {
            DataSet dsResult = new DataSet();
            ...
            string SQL_DELETE_SUB_CONTEXT_KEY =
                "DELETE FROM " + modelContextMstTblName + 
               @" WHERE MODEL_CONFIG_RAWID IN 
                      (SELECT RAWID 
                         FROM " + modelConfigMstTblName +
               ...
               @"                              WHERE RAWID = :RAWID)
                          AND MAIN_YN = 'N')
                    AND CONTEXT_KEY NOT IN (SELECT CONTEXT_KEY 
                                              FROM " + modelContextMstTblName +
               @"                            WHERE MODEL_CONFIG_RAWID = :RAWID) ";

            string SQL_UPDATE_SUB_CONTEXT_KEY_ORDER = 
                "UPDATE " + modelContextMstTblName + " A " + 
               @" SET A.KEY_ORDER = 
                     (SELECT KEY_ORDER 
                        FROM " + modelContextMstTblName + " B " + 
               @"      WHERE MODEL_CONFIG_RAWID = :RAWID 
                         AND A.CONTEXT_KEY = B.CONTEXT_KEY)
                  WHERE A.MODEL_CONFIG_RAWID IN (SELECT RAWID 
                                                   FROM " + modelConfigMstTblName + 
               @"                                 WHERE MODEL_RAWID IN (SELECT MODEL_RAWID 
                                                                          FROM " + modelConfigMstTblName +
               @"                                                        WHERE RAWID = :RAWID)
            ...
            string SQL_UPDATE_SUB_CONTEXT_VALUE_GROUP = 
                "UPDATE " + modelContextMstTblName + " A " + 
               @" SET (A.CONTEXT_VALUE, A.EXCLUDE_LIST) = 
                      (SELECT CONTEXT_VALUE, EXCLUDE_LIST 
                         FROM " + modelContextMstTblName + " B " +
               @"       WHERE MODEL_CONFIG_RAWID = :RAWID 
                          AND A.CONTEXT_KEY = B.CONTEXT_KEY 
                          AND B.GROUP_YN = 'Y')
            ...
            string SQL_SELECT_SUB_CONFIG_RAWID_FOR_CONTEXT_SAVE = 
                " SELECT RAWID                                                   " +
                "   FROM " + modelConfigMstTblName                                 +
                "  WHERE MODEL_RAWID = (SELECT MODEL_RAWID                       " +
                "                         FROM " + modelConfigMstTblName           +
                ...
                if (!isOnlyMainGroup)
                {
                    ...
                    if (drArrTemp.Length > 0)
                    {
                        ...
                        if (dsTemp.Tables[0].Rows.Count > 0)
                        {
                            ...
                            decimal ddxRawID = base.GetSequenceCount(seqModelContextMst, dsTemp.Tables[0].Rows.Count * drArrTemp.Length);
                            ...
                            if (arrTempRawID.Count > 0)
                            {
                                ...
                                base.InsertBatch(modelContextMstTblName, llstFieldData);
        ...
        public DataSet GetGroupContextValue(byte[] param)
        {
            ...
            //refactoring 전에는 전역변수였음. by KBLEE, start
            string SQL_SELECT_GROUP_CONTEXT_VALUE = 
        ...
        public DataSet SearchByArea(byte[] param)
        {
            ...
            //refactoring 전까지 전역변수였음. by KBLEE, start
            //SPC Rule, Ocap List 추가
            string SQL_SEARCH_BY_AREA = @"SELECT MMS.EQP_MODEL, MMS.SPC_MODEL_NAME, '' EQP_ID_CONTEXT,
            ...
            string SQL_SEARCH_BY_AREA_CONTEXT_KEY_VALUE = 
                ...
                " WHERE   MMS.AREA_RAWID = :AREA";
            //refactoring 전까지 전역변수였음. by KBLEE, end
        ...
        public DataSet SearchByAreaSPCModelName(byte[] param)
        {
            ...
            string SQL_SEARCH_BY_AREA_SPC_MODEL_NAME =
        ...
        public DataSet GetSPCCalcContextKey(byte[] param)
        {
            ...
            //refactoring 전에 전역변수였음 by KBLEE, start
            string SQL_SEARCH_CONTEXT_KEY = 
                " SELECT DISTINCT CONTEXT_KEY, CONTEXT_VALUE                                 "
              + "            FROM MODEL_CONTEXT_MST_SPC                                      "
              + "           WHERE MODEL_CONFIG_RAWID IN (                                    "
              + "                    SELECT A.MODEL_CONFIG_RAWID                             "
              + "                      FROM (SELECT MODEL_CONFIG_RAWID                       "
              ...
              + "                       AND MAIN_YN = 'N') {4}                               "
              + "                       ORDER BY CONTEXT_KEY, CONTEXT_VALUE                  ";
            //refactoring 전에 전역변수였음 by KBLEE, end
        ...
        public DataSet CopyModelInfo(LinkedList llstParam, bool isATT)
        {
            ...
            //refactoring 전에는 전역변수였음. by KBLEE, start
            string SQL_COPY_MODEL_FOR_MODEL_CONFIG_MST_SPC = " UPDATE " + modelConfigMstTblName + " SET ";

            string SQL_COPY_MODEL_FOR_INSERT_MODEL_RULE_MST_SPC = 
                " INSERT INTO " + modelRuleMstTblName + 
                "             (RAWID, MODEL_CONFIG_RAWID, SPC_RULE_NO, OCAP_LIST, USE_MAIN_SPEC_YN,  " +
                "              RULE_ORDER, CREATE_DTTS, CREATE_BY, LAST_UPDATE_DTTS, LAST_UPDATE_BY) " +
                "       SELECT " + seqModelRuleMst + ".NEXTVAL, :TARGET_MODEL_CONFIG_RAWID,          " +
                "              SPC_RULE_NO, OCAP_LIST, USE_MAIN_SPEC_YN, RULE_ORDER, SYSTIMESTAMP,   " +
                "              :USER_ID, SYSTIMESTAMP, :USER_ID                                      " +
                "       FROM " +    modelRuleMstTblName                                                +
                "       WHERE   MODEL_CONFIG_RAWID = :SOURCE_MODEL_CONFIG_RAWID                      ";

            string SQL_COPY_MODEL_FOR_INSERT_MODEL_RULE_OPT_MST_SPC = 
                " INSERT INTO " + modelRuleOptMstTblName + 
                "             (RAWID, MODEL_RULE_RAWID, RULE_OPTION_NO, CREATE_DTTS, CREATE_BY, " +
                "              LAST_UPDATE_DTTS, LAST_UPDATE_BY, RULE_OPTION_VALUE)             " +
                "       SELECT " + seqModelRuleOptMst + ".NEXTVAL,                              " +
                "               (SELECT RAWID                                                   " +
                "                FROM " + modelRuleMstTblName                                     + 
                "                WHERE MODEL_CONFIG_RAWID = :TARGET_MODEL_CONFIG_RAWID          " +
                "                  AND SPC_RULE_NO = MR.SPC_RULE_NO ),                          " +
                "               MO.RULE_OPTION_NO, SYSTIMESTAMP, :USER_ID, SYSTIMESTAMP,        " +
                "               :USER_ID, MO.RULE_OPTION_VALUE                                  " +
                "       FROM " + modelRuleMstTblName + " MR                                     " +
                "               INNER JOIN " + modelRuleOptMstTblName + " MO                    " +
                "                   ON MR.RAWID = MO.MODEL_RULE_RAWID                           " +
                "       WHERE   MR.MODEL_CONFIG_RAWID = :SOURCE_MODEL_CONFIG_RAWID              ";

            string SQL_COPY_MODEL_FOR_MODEL_CONFIG_OPT_MST_SPC = " UPDATE " + modelConfigOptMstTblName + " SET ";

            string SQL_COPY_MODEL_FOR_MODEL_AUTOCALC_MST_SPC = " UPDATE " + modelAutoCalcMstTblName + " SET ";
            //refactoring 전에는 전역변수였음. by KBLEE, end
            ...
            try
            {
                ...
                string tableName = modelConfigMstTblName;
                ...
                if (ruleSelection.Trim().ToUpper() == "Y")
                {
                    ...
                    string sWhereQuery = string.Format("WHERE {0} IN (SELECT RAWID FROM {1} WHERE {2} = :{2}) ",
                        COLUMN.MODEL_RULE_RAWID, modelRuleMstTblName, COLUMN.MODEL_CONFIG_RAWID);

                    llstFieldData.Add(COLUMN.MODEL_CONFIG_RAWID, targetConfigRawID);

                    base.Delete(modelRuleOptMstTblName, sWhereQuery, llstFieldData);
                    ...
                    sWhereQuery = string.Format("WHERE {0} = :{0}", COLUMN.MODEL_CONFIG_RAWID);
                    base.Delete(modelRuleMstTblName, sWhereQuery, llstFieldData);
                ...
                isEmpty = true;
                sbQuery.Length = 0;
                tableName = modelConfigOptMstTblName;
                ...
                isEmpty = true;
                sbQuery.Length = 0;
                tableName = modelAutoCalcMstTblName;
                ...
                if (llstParam[Definition.COPY_MODEL.CONTEXT_CONTEXT_INFORMATION].ToString().Equals("Y"))
                {
                    string queryGetSourceContext =
                        @"SELECT context_key, context_value 
                            FROM " + modelContextMstTblName +  
                        @" WHERE 1=1 AND model_config_rawid = " + sourceConfigRawID;
        ...
        public DataSet GetSPCModelContextInfo(byte[] baData, bool isATT)
        {
            ...
            //refactoring 전에는 전역변수였음 by KBLEE, start
            //Chris
            string SQL_MODEL_HISTORY_CONTEXT =
                        @"SELECT MCMS2.MODEL_CONFIG_RAWID, MCMS2.CONTEXT_KEY, MCMS2.CONTEXT_VALUE
                          FROM " + modelMstTblName + @" MMS 
                               INNER JOIN " + modelConfigMstTblName + @" MCMS
                                        ON MMS.RAWID = MCMS.MODEL_RAWID
                               INNER JOIN " + modelContextMstTblName + @" MCMS2
        ...
        public DataSet GetSPCModelHistoryInfo(byte[] baData, bool isATT)
        {
            LinkedList llstData = new LinkedList();
            llstData.SetSerialData(baData);

            //ATT에 따른 처리 by KBLEE, Start
            string modelConfigHstTblName = string.Empty;

            if (isATT)
            {
                modelConfigHstTblName = TABLE.MODEL_CONFIG_ATT_HST_SPC;
            }
            else
            {
                modelConfigHstTblName = TABLE.MODEL_CONFIG_HST_SPC;
            }
            //ATT에 따른 처리 by KBLEE, End

            //Chris
            string SQL_MODEL_CONFIG_HISTORY =
                "SELECT * " +
                " FROM " + modelConfigHstTblName +
                " WHERE MODIFIED_TYPE_CD = 'AC' " +
        ...
        public bool IncreaseVersionOfSubConfigs(string sMainConfigRawID, bool isATT)
        {
            bool bResult = true;
            ...
            //refactoring 전에는 전역변수였음. by KBLEE, start
            string strQuery_MCMS = "UPDATE " + modelConfigMstTblName + @" A 
            ...
            string strQuery_MCOMS = "UPDATE " + modelConfigOptMstTblName + @" A
            ...
            string strQuery_MCTXMS = "UPDATE " +modelContextMstTblName + @" A
                                       SET VERSION = ( SELECT VERSION 
                                                       FROM " + modelConfigMstTblName +
                                    @"                 WHERE RAWID = A.MODEL_CONFIG_RAWID )
                                       WHERE MODEL_CONFIG_RAWID IN (
            ...
            string strQuery_MAMS = "UPDATE " + modelAutoCalcMstTblName + @" A
                                       SET VERSION = ( SELECT VERSION 
                                                       FROM " + modelConfigMstTblName +
                                  @"                   WHERE RAWID = A.MODEL_CONFIG_RAWID )
                                       WHERE MODEL_CONFIG_RAWID IN (
            ...
            string strQuery_MRMS = "UPDATE " + modelRuleMstTblName + @" A
                                       SET VERSION = ( SELECT VERSION 
                                                       FROM " + modelConfigMstTblName +
                                  @"                   WHERE RAWID = A.MODEL_CONFIG_RAWID )
                                       WHERE MODEL_CONFIG_RAWID IN (
            ...
            string strQuery_MROMS = "UPDATE " + modelRuleOptMstTblName + @" A
                                       SET VERSION = ( SELECT VERSION 
                                                       FROM " + modelRuleMstTblName +
        ...
        public bool GetUseNormalValuebyChartID(byte[] param)
        {
            ...
            try
            {
                ...
                {
                    llstCondition.Add("MODEL_CONFIG_RAWID", _ComUtil.NVL(llstParam[Definition.CONDITION_KEY_MODEL_CONFIG_RAWID]));
                    sb.Append("SELECT NVL(USE_NORM_YN, 'N') USE_NORMAL ");
                    sb.Append(" FROM MODEL_CONFIG_MST_SPC ");
                    sb.Append(" WHERE MODEL_RAWID = (SELECT MODEL_RAWID ");
                    sb.Append("                      FROM MODEL_CONFIG_MST_SPC ");
                    sb.Append("                      WHERE RAWID = :MODEL_CONFIG_RAWID) ");
                    sb.Append(" AND MAIN_YN = 'Y' ");
                }
        ...
        //SPC-855 By Louis
        public DataSet GetTargetConfigSpecData(string[] targetList, bool isATT)
        {
            DataSet dsResult = new DataSet();
                ...
                if (targetList.Length != 0)
                {
                    ...
                    if (targetList.Length > 1000)
                    {
                        ...
                        for (int k = 0; k < arrsModelRawID.Count; k++)
                        {
                            ...
                            if (isATT)
                            {
                                sqlQuery = string.Format(@"SELECT RAWID, PN_USL, PN_LSL, PN_UCL, PN_LCL, 
                                                                  C_USL, C_LSL, C_UCL, C_LCL
											               FROM MODEL_CONFIG_ATT_MST_SPC WHERE {0} ", strWhere);
                            }
                            else
                            {
                                sqlQuery = string.Format(@"SELECT RAWID, UPPER_SPEC, LOWER_SPEC, UPPER_CONTROL, 
                                                                  LOWER_CONTROL, RAW_UCL, RAW_LCL
        ...
        public DataSet GetSourceConfigSpecData(string rawid, bool isATT)
        {
            DataSet dsResult = new DataSet();
            string sqlQuery = string.Empty;
            string strWhere = string.Empty;
        ...
        public DataSet CreateAutoCalculationDataSheet(byte[] baData)
        {
            ...
            //refactoring 전에 전역변수였음. by KBLEE, start
            string SQL_CREATE_AUTO_CALC_DATA_SHEET = 
                "SELECT NAME, NULL AS CALCULATION_YN, NULL AS CALCULATION_COUNT, " +
        ...
        public DataSet GetSPCModelGroupList(bool isMET, bool isATT)
        {
            ...
            if (level == Definition.CONDITION_KEY_AREA)
            {
                ...
                sb.Append(" GROUP BY LINE_RAWID, AREA_RAWID, AREA, EQPMODEL ");
                ...
                if (isATT)
                {
                    ...
                    sb.Append(" FROM " + modelGroupMstTblName + " A, EQP_VW_SPC B                                   ");
                ...
                if (isATT)
                {
                    sb.Append("SELECT B.RAWID, B.LOCATION_RAWID, B.AREA_RAWID, A.AREA AS GROUP_LEVEL,                    ");
                    sb.Append("       B.SPC_MODEL_NAME , B.GROUP_NAME                                                    ");
                    sb.Append(" FROM (  SELECT A.AREA, B.LOCATION_RAWID, B.AREA_RAWID                                    ");
                    sb.Append("              FROM EQP_VW_SPC A, " + modelMstTblName + " B                                ");
                    ...
                    sb.Append("              FROM " + modelMstTblName + " B, " + modelGroupMstTblName + " C              ");
                    ...
                    sb.Append("                   B.GROUP_RAWID,                                                         ");
                    sb.Append("                   B.SPC_MODEL_NAME,                                                      ");
                    sb.Append("                   C.GROUP_NAME) B , " + modelConfigMstTblName + " C                      ");
                    ...
                    sb.Append(" UNION ALL                                                                                ");
                    sb.Append(" SELECT B.RAWID, B.LOCATION_RAWID, B.AREA_RAWID, A.AREA AS GROUP_LEVEL,                   ");
                    sb.Append("        B.SPC_MODEL_NAME , 'UNASSIGNED MODEL' AS GROUP_NAME                               ");
                    sb.Append(" FROM EQP_VW_SPC  A, " + modelMstTblName + " B, " + modelConfigMstTblName + " C           ");
                ...
                else
                {
                    ...
                    sb.Append(" FROM " + modelMstTblName + " b,  ");
                    sb.Append(modelConfigMstTblName + " c,  ");
                    sb.Append(modelGroupMstTblName + " d  ");
                    sb.Append(" WHERE 1=1  ");
            ...
            else
            {
                if (!isATT)
                {
                    ...
                    sb.Append(" FROM EQP_VW_SPC ");
                    sb.Append(" GROUP BY LINE_RAWID, AREA_RAWID, EQPMODEL ");
                    sb.Append(" ORDER BY GROUP_LEVEL ASC ");
        ...
        public bool SaveSPCGroupList(DataSet dsSave, byte[] param, bool isATT)
        {
            bool bResult = false;
            LinkedList llParam = new LinkedList();
            LinkedList llstFieldData = new LinkedList();
                ...
                if (dsSave.Tables.Count > 0)
                {
                    if (dsSave.Tables.Contains(TABLE.DATA_SAVE_DELETE))
                    {
                        ...
                        foreach (DataRow row in dsSave.Tables[TABLE.DATA_SAVE_DELETE].Rows)
                        {
                            ...
                            StringBuilder sbQuery = new StringBuilder();
                            sbQuery.Append("SELECT A.* ");
                            sbQuery.Append(" FROM " + modelMstTblName + " A, ");
                            sbQuery.Append(           modelGroupMstTblName + " B ");
                            ...
                            {
                                string sQuery = "UPDATE " + modelMstTblName + 
                                                " SET GROUP_RAWID = NULL " +
                                                " WHERE GROUP_RAWID =: GROUP_RAWID";
                            ...
                            base.Delete(modelGroupMstTblName, sWhereQuery, ll);
                        }
                    }
                    ...
                    if (dsSave.Tables.Contains(TABLE.DATA_SAVE_UPDATE))
                    {
                        ...
                        foreach (DataRow row in dsSave.Tables[TABLE.DATA_SAVE_UPDATE].Rows)
                        {
                            ...
                            base.Update(modelGroupMstTblName, llstFieldData, sWhereQuery, ll);
                        }
                    }
                    ...
                    if (dsSave.Tables.Contains(TABLE.DATA_SAVE_INSERT))
                    {
                        foreach (DataRow row in dsSave.Tables[TABLE.DATA_SAVE_INSERT].Rows)
                        {
                            ...
                            base.Insert(modelGroupMstTblName, llstFieldData);
                        }
                    }
        ...
        public bool SaveSPCModelMapping(DataSet dsSave, byte[] param, bool isATT)
        {
            bool bResult = false;
            ...
            try
            {
                if (dsSave.Tables.Contains(TABLE.DATA_SAVE_INSERT))
                {
                    foreach (DataRow row in dsSave.Tables[TABLE.DATA_SAVE_INSERT].Rows)
                    {
                        ...
                        base.Update(modelMstTblName, llstFieldData, sWhereQuery, llParam);
                    }
                }
        ...
        public DataSet GetGroupList(byte[] param, bool isATT)
        {
            DataSet dsResult = null;
            LinkedList llParam = new LinkedList();
            llParam.SetSerialData(param);
        ...
        public DataSet GetGroupNameByChartId(string chartId, bool isATT)
        {
            DataSet dsResult = new DataSet();
            LinkedList ll = new LinkedList();
            StringBuilder sb = new StringBuilder();
            ...
            {
                sb.Append("SELECT A.*                                                                ");
                sb.Append(" FROM " + modelGroupMstTblName + " A                                      ");
                sb.Append(" WHERE RAWID = (SELECT C.GROUP_RAWID                                      ");
                sb.Append("                  FROM " + modelConfigMstTblName + " B,                   ");
                sb.Append(                            modelMstTblName + " C                          ");
        ...
        public bool CheckDuplicateGroupName(DataSet dsSave, byte[] param, bool isATT)
        {
            bool bResult = true;
            DataSet ds = new DataSet();
        ...
        public string CheckDuplicateMapping(DataTable dt, bool isEmptyGroupRawid, bool isATT)
        {
